...
M_IMM      = 10
M_REL      = 11
M_ZIND     = 12     # zero page indirect, 65C02
M_ABINDX   = 13     # for jmp $7C in 65C02
...
#for i in range(l):
#    if opcode[i][0]:
#        print (hex(i),"=",opcode[i][0], "\t", opcode[i][1])
...
#
    ...
    print(hex(pc)[2:].zfill(4), ":\t", sep="", end="")
...
#		case M_IND:
        ...
        d = hex(one)[2:].zfill(2) + " "
        d += hex(two)[2:].zfill(2) + " "
        d += hex(three)[2:].zfill(2) + "\t"
        d += s + " ($" + hex(join(two,three))[2:].zfill(4) + ")"
        print(d)
        count = 3
...
#		case M_ABSX:
        ...
        d += hex(two)[2:].zfill(2) + " "
        d += hex(three)[2:].zfill(2) + "\t"
        d += s + " $" + hex(join(two,three))[2:].zfill(4) + ",X"
        print(d)
        count = 3
...
#		case M_ABSY:
        ...
        d += hex(two)[2:].zfill(2) + " "
        d += hex(three)[2:].zfill(2) + "\t"
        d += s + " $" + hex(join(two,three))[2:].zfill(4) + ",Y"
        print(d)
        count = 3
